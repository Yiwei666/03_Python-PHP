...
<body>
    <div class="image-container">
        <?php if ($prevIndex >= 0): ?>
            <button class="arrow arrow-left" onclick="window.location.href='08_image_leftRight_navigation_starF.php?id=<?php echo $validImages[$prevIndex]['id']; ?>&sort=<?php echo $sortType; ?>'">←</button>
        <?php endif; ?>
        ...
        <?php if ($nextIndex >= 0): ?>
            <button class="arrow arrow-right" onclick="window.location.href='08_image_leftRight_navigation_starF.php?id=<?php echo $validImages[$nextIndex]['id']; ?>&sort=<?php echo $sortType; ?>'">→</button>
        <?php endif; ?>
    </div>
</body>
</html>
