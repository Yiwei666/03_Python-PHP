...
<body>
    ...
    $videoPath = '/home/01_html/03_highqualityMV/';
    $videos = glob($videoPath . '*.mp4');
    $totalVideos = count($videos);
    $videosPerRow = 1; // 可以根据需要更改每行显示的视频数量
    ...
    if ($totalVideos > 0) {
        ...
        for ($i = 0; $i < $rows; $i++) {
            ...
            for ($j = 0; $j < $videosPerRow; $j++) {
                ...
                $videoUrl = $domain . '/03_highqualityMV/' . $videoName;
                echo '<div class="video">';
                echo '<video controls width="800" height="600" onended="playNextVideo(this)">'; // 添加onended事件
