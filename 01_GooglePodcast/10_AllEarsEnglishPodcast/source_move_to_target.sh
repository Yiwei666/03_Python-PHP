...
# 指定目录A和目录B
directory_a="/home/01_html/46_AllEarsEnglishPodcast/01_audio"
directory_b="/home/01_html/46_AllEarsEnglishPodcast/02_audio"

# 指定源文件路径
source_file="/home/01_html/46_AllEarsEnglishPodcast/source.txt"
