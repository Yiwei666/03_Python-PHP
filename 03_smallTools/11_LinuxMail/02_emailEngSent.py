...
def send_email(sender_email, sender_password, receiver_email, subject, body, attachment_path, sent_pdf_list_path):
    # 设置邮件服务器和端口
...
if __name__ == "__main__":
    ...
    receiver_email = 'receiver@gmail.com'            # 收件者
    ...
    # 发送邮件
    send_email(sender_email, sender_password, receiver_email, subject, body, None, sent_pdf_list_path)
