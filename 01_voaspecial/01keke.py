...
url_01 = '/home/01_html/30_VOAspecial/latest.html'

url_02 = '/home/01_html/30_VOAspecial/homePageUrl.txt'       # 存储所有子页面链接
...
# 按照要求逐级细化查找
a_tags = soup.find('div', class_='main').find('div', class_='box').find('div', class_='lastPage_left')\
...
for s in urlList:
    ...
    if match:
        ...
        with open( url_02 , 'a+') as f:
            ...
            elif not link.startswith('http://www.kekenet.com/broadcast/'):           # 判断格式不规范的链接
