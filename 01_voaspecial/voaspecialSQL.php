...
$servername = "localhost"; // 修改为您的数据库服务器名
$username = "root";     // 修改为您的数据库用户名
$password = "password123";     // 修改为您的数据库密码
...
$sql = "SELECT datetime, url FROM voaspecialTABLE ORDER BY RAND() LIMIT 15"; // 修改为您的表名
