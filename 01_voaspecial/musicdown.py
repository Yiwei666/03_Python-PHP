...
url_01 = '/home/01_html/30_VOAspecial/homePageUrl.txt'        # 保存有所有子页面链接
url_02 = '/home/01_html/30_VOAspecial/music.html'          # 下载的子页面html文件，覆盖保存
url_03 = '/home/01_html/30_VOAspecial/audioUrl.txt'      # 音频链接

with open( url_01 , 'r') as f:   # homePageUrl.txt 为保存所有音频链接的文本
    links = f.readlines()
