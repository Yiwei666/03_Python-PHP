...
<head>
    ...
    <link rel="shortcut icon" href="https://domian.com/00_logo/usa.png">
    <style>
        :root {
            --video-row-gap: 5px;
...
<body>
    <?php
    $domain = 'https://domian.com';
    $videoPath = '/home/01_html/10_TOEFL/01_yubeiduan/';
    ...
    if ($totalVideos > 0) {
        ...
        for ($i = $startIndex; $i < $endIndex; $i++) {
            ...
            $videoUrl = $domain . '/10_TOEFL/01_yubeiduan/' . $videoName;
            ...
            echo '<video controls width="600" height="450" onended="playNextVideo(this)">';
